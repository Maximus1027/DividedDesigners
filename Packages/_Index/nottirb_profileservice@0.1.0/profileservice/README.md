...
DataStore profiles. This version of ProfileService is intended to be used with [Wally](https://github.com/UpliftGames/wally), see the [package description](https://wally.run/package/brittonfischer/profileservice) for installation information. Or, just add the following as a dependency to your wally.toml:
...
**[MadStudioRoblox/ProfileService](https://github.com/MadStudioRoblox/ProfileService)**
